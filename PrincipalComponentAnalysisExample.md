...
Principal Component Analysis (PCA) is a popular and simple to implement classification technique, often used in face recognition.  The following is an example of how to implement it in EJML.  It is assumed that the reader is already familiar with PCA.

See examples/src/PrincipalComponentAnalysis.java in EJML's source code.

For additional information on PCA:
  * [General information on Wikipedia](http://en.wikipedia.org/wiki/Principal_component_analysis)
